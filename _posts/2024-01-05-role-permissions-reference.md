...
| `dataExports.accessCustom` | Permission to export custom data sets and create specialized reports. Required in each company included in a [custom data export](#/custom-data-exports) |
