...
- **Company structure units** - Organizational units; users and audit objects are linked to units for assignments and filtering (see [Get company structure units](#/get-company-structure-units)). Legacy user groups and audit object groups are deprecated in favor of unit IDs in API parameters where older names remain
