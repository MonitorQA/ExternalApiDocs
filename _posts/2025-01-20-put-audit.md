...
This method allows you to update a one-time audit. You can modify the audit's dates, name, hint, and assignee. Note that this method does not allow changing the template or audit object associated with the audit, and it only works with one-time audits.
