...
The maximum response time, which is the time the service waits for an HTTP response, is 10 seconds. 

In case of a network error or response timeout, the request is retried. The maximum number of retries is 5.
